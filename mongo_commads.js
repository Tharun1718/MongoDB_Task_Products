...
// 1. all the information about the products
db.products.find({})

// 2. product price which are between 400 to 800
db.products.find({product_price: {$gt : 400, $lt : 800}})

// 3. product price which are not between 600 to 800
db.products.find({ $and : [ { $or: [{product_price: {$lt: 600}},{product_price: {$gt: 800}}]} ] })

// 4. four products greater than 500
...
// 6. product with a row id = 10
db.products.find({ id: '10' })

// 7. product name and material of product with a row id = 10
...
// 10. delete products with same product prices
